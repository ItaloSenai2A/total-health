...
const Consulta = () => {
  ...
  const consultas = [
    { id: 1, paciente: "João Silva", data: "2023-10-01", medico: "Dr. Tal", status: "Agendada", valor: "R$500,00" },
    {
      id: 2,
    ...
    <div className="container-fluid p-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div className="position-relative" style={{ maxWidth: "300px" }}>
          <input type="text" className="form-control pe-5" placeholder="Buscar" />
      ...
      <div className="row g-4">
        ...
        <div className="col-12 col-md-6 col-lg-4 col-xl-3">
          ...
          >
            <div className="card-body d-flex flex-column align-items-center justify-content-center p-4">
              <div className="text-primary mb-3" style={{ width: "80px", height: "80px" }}>
        ...
        {/* Cards para consultas cadastradas - mantendo o conteúdo original */}
        {consultas.map((consulta) => (
          <div className="col-12 col-md-6 col-lg-4 col-xl-3" key={consulta.id}>
            <div
              className="card h-100"
              style={{ borderRadius: "8px", border: "1px solid #f0f0f0", boxShadow: "0 2px 5px rgba(0,0,0,0.05)" }}
            >
              <div className="card-body p-3">
                {/* Header with patient name and menu */}
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h5 className="card-title text-danger">{consulta.paciente}</h5>
                  <button className="btn btn-sm btn-light rounded-circle p-1">⋮</button>
                </div>
